      ...
      <Container as="section">
        <Inner>
          ...
          <p className={`mt-4 md:mt-8 max-w-xl mx-auto`}>
            整体院あす香では、お客様がつらい頭痛から「卒業」し、痛みのない元気な毎日を過ごせるよう、心をこめてサポートいたします。頭痛・肩こりの根本原因を「脳とカラダのつながり」から考えてアプローチする確かな技術、オールハンド（手技）によるやさしい施術、「頭痛・肩こりの起きにくい体質」を作るための日々のセルフケア指導まで、あらゆる面からお客様の症状と向き合います。どうぞお気軽にご相談ください。
          </p>
        </Inner>
      </Container>
