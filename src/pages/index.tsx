          ...
          <div className={'relative'}>
            <div className={`relative z-10`}>
              ...
              <p className={`mt-2 md:mt-4`}>
                整体院あす香は、頭痛・肩こり専門の整体院です。お客様がつらい痛みや不調から「卒業」し、元気な毎日を過ごせるよう、心をこめてサポートいたします。
                <br />
            ...
            {[
              {
                ...
                body: '筋肉・筋膜・関節だけでなく、「脳からカラダを考える」機能神経学に基づいて末梢神経・前庭器官（三半規管・耳石器）・目の動き等をテストし、脊髄・小脳・脳幹・皮質・島皮質など、不調の根本原因にアプローチします。',
              },
              {
                title: '2. セルフケアまでサポート',
        ...
        <Inner>
          ...
          >
            ...
            <div className={`mt-4 md:mt-0 md:[grid-area:info;] md:p-4`}>
              ...
              <ul className={`mt-2`}>
                {[
                  'Functional Neuro Training 認定トレーナー（アドバンス）',
